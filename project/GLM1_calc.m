...
GLM_levodopa.D = zeros(size(levodopa_stable_MMN, 1), 4*size(levodopa_stable_MMN, 2)+4);
for i=1:size(levodopa_stable_MMN, 1)
    ...
    GLM_levodopa.D(i,:) = [b_eps2_stable; b_eps3_stable; b_eps2_volatile; b_eps3_volatile];
end
...
GLM_galantamine.D = zeros(size(galantamine_stable_MMN, 1), 4*size(galantamine_stable_MMN, 2)+4);
for i=1:size(galantamine_stable_MMN, 1)
    ...
    GLM_galantamine.D(i,:) = [b_eps2_stable; b_eps3_stable; b_eps2_volatile; b_eps3_volatile];
end
...
GLM_amisulpride.D = zeros(size(amisulpride_stable_MMN, 1), 4*size(amisulpride_stable_MMN, 2)+4);
for i=1:size(amisulpride_stable_MMN, 1)
    ...
    GLM_amisulpride.D(i,:) = [b_eps2_stable; b_eps3_stable; b_eps2_volatile; b_eps3_volatile];
end
...
GLM_biperiden.D = zeros(size(biperiden_stable_MMN, 1), 4*size(biperiden_stable_MMN, 2)+4);
for i=1:size(biperiden_stable_MMN, 1)
    ...
    GLM_biperiden.D(i,:) = [b_eps2_stable; b_eps3_stable; b_eps2_volatile; b_eps3_volatile];
end
...
GLM_placebo.D = zeros(size(placebo_stable_MMN, 1), 4*size(placebo_stable_MMN, 2)+4);
for i=1:size(placebo_stable_MMN, 1)
    ...
    GLM_placebo.D(i,:) = [b_eps2_stable; b_eps3_stable; b_eps2_volatile; b_eps3_volatile];
end

%% Save GLM weights
save GLM1_levodopa.mat GLM_levodopa
save GLM1_galantamine.mat GLM_galantamine
save GLM1_amisulpride.mat GLM_amisulpride
save GLM1_biperiden.mat GLM_biperiden
save GLM1_placebo.mat GLM_placebo

%% Test EPS2 Stable
eps2_stable_pred = glmval(GLM_placebo.D(10,1:127)',squeeze(placebo_stable_MMN(10,:,:))', 'identity');
figure
plot(eps2_stable)
hold on
...
%% Test EPS3 Stable
eps3_stable_pred = glmval(GLM_placebo.D(10,128:254)',squeeze(placebo_stable_MMN(10,:,:))', 'identity');
figure
plot(eps3_stable)
hold on
...
%% Test EPS2 Volatile
eps2_volatile_pred = glmval(GLM_placebo.D(10,255:381)',squeeze(placebo_volatile_MMN(10,:,:))', 'identity');
figure
plot(eps2_volatile)
hold on
...
%% Test EPS3 Volatile
eps3_volatile_pred = glmval(GLM_placebo.D(10,382:508)',squeeze(placebo_volatile_MMN(10,:,:))', 'identity');
figure
plot(eps3_volatile)
hold on
